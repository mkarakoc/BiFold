...
def v_Xdm3yn_cabgn(dd_name='bdm3y1', vnn_name='reid'):
    ...
    params_dict = {
        'reid':{        #C      alpha     beta   gamma   n    K [MeV]  Implemented
            ...
            'bdm3y2': (1.0678,   0.000, 0.0000, 5.1069,  2.0,  354,    False),
            'bdm3y3': (1.0153,   0.000, 0.0000, 21.073,  3.0,  475,    False)
        },
        'paris': {      # C     alpha    beta     gamma   n    K [MeV]  Implemented
            ...
            'bdm3y2': (1.0664,  0.0000,  0.000,  6.0296,  2.0,   418,   False),
            'bdm3y3': (1.0045,  0.0000,  0.000, 25.1150,  3.0,   566,   False),
