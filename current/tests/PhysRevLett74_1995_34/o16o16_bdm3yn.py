...
u_fig1_bdm3y2_e_poly = [-0.00478097,0.127836,-1.27976,6.21061,-19.6789,57.0656,-10.5408,-480.77]
...
u_fig1_bdm3y2_e = f_extrapolate(R, 0.0350, 7.9886, u_fig1_bdm3y2_e_poly)
...
u_fig1_bdm3y3_e_poly = [-0.00852613,0.233191,-2.38312,11.1365,-25.4047,42.187,-12.4919,-365.869]
...
u_fig1_bdm3y3_e = f_extrapolate(R, 0.0414, 7.9854, u_fig1_bdm3y3_e_poly)
...
fig1_e = [
pplot(R, u_fig1_bdm3y1_e, label='exchange - bdm3y1',linestyle = 'None', marker='v', markevery=markevery, color='green', alpha=0.5, zorder=999),
pplot(R, u_fig1_bdm3y2_e, label='exchange - bdm3y2',linestyle = 'None', marker='v', markevery=markevery, color='blue', alpha=0.5, zorder=999),
pplot(R, u_fig1_bdm3y3_e, label='exchange - bdm3y3',linestyle = 'None', marker='v', markevery=markevery, color='red', alpha=0.5, zorder=999)
    ]
...
plot_potentials([u_bdm3y1, u_bdm3y2, u_bdm3y3], R, part='exchange', add_plot=fig1_e, suptitle=suptitle, title=title,
                linestyles=['dashed', 'dotted', 'solid'], xlimit=(0,8))
